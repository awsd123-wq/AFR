...
def parse_args():
    ...
    parser.add_argument("--max_step", type=int, default=5000, help="maximum iteration to train")
    ...
    parser.add_argument("--optuna", action="store_false", help="Disable optuna hyperparameter search")
    ...
    # ========================= Model Configs ==========================
    parser.add_argument("--arch", type=lambda s: [int(i) for i in s.split('_')], default="3_2_3", help="[convs, stem transformers, branch transformers]")
    parser.add_argument("--scale_factor", type=int, default=1, help="scale factor between fpn branch layers.")
    ...
    parser.add_argument("--se_ratio", type=int, default=2, help="reduction factor in se context gating")
