...
def parse_args():
    ...
    parser.add_argument("--batch_size", default=5, type=int, help="number of instances in a batch of data") # ☆
    ...
    # ========================= Model Configs ==========================
    parser.add_argument("--arch", type=lambda s: [int(i) for i in s.split('_')], default="2_2_4", help="[convs, stem transformers, branch transformers]")
